var playState1 = {
    ...
    create: function() { 
		...
		//Player
        this.player = game.add.sprite(game.width/2-60, game.height/2, 'player');
	...
	addMobileInputs: function() {
		// Add the jump button
    	var jumpButton = game.add.sprite(350, 290, 'jumpButton');
    	...
    	var leftButton = game.add.sprite(50, 290, 'leftButton');
    	...
    	var rightButton = game.add.sprite(130, 290, 'rightButton');
